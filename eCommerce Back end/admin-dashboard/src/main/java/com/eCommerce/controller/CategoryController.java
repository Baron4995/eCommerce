...
//	@GetMapping(value = "searchCategoryByName/{categoryName}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//	}
	...
	@PostMapping(value = "searchCategoryByName", produces = MediaType.APPLICATION_JSON_VALUE)
